...
const Service = () => {
    return (
      ...
      <div className='relative ml-6'    > <span className=" text-4xl font-bold font-sans text-[#FFFFFF]">Services</span></div>
        ...
        <h1 className='text-[#000000]  -mt-30 font-bold text-3xl w-50 h-[63px] font-sans '>Services</h1>
     
    
        <p className='text-[#000000] font-sans   w-250'>established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of</p>
       <p className='text-[#000000] font-sans  w-160'> using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as</p>
