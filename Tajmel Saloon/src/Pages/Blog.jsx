    ...
    <div className="w-full h-full  ">
      ...
      <div className="w-full h-full flex">
        <div className="flex flex-col ml-13 mt-25">
          ...
          <button className=" text-[#010101] w-25 h-8  mt-3  text-[13px] border border-[#EE2478]">
            Get the App
          </button>
      ...
      <div className="mt-40  py-0 px-0 -ml-30   bg-[#F8F8FA] w-[1600px] h-[700px] ">
        <div className="flex  ml-30">
          ...
          <div className="flex flex-col mt-60  -ml-65">
            ...
            <button className=" text-[#010101]  w-25 h-8 mt-4 mb-1 border border-[#EE2478]">
              Get the App
            </button>
            <div className="w-[330px] h-[39px] flex mt-5 space-x-20">
              <div className="flex space-x-1 ">
                ...
                <p className="text-[#0C0C0C] font-bold   font-[Brandon] text-[12px]">
