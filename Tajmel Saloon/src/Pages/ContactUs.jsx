  ...
  const subjectOptions = [
    {
      ...
      label: (
        <>
          <FaHashtag className="inline-block mr-2" /> One
        </>
      ),
    },
    {
      ...
      label: (
        <>
          <FaCheckCircle className="inline-block mr-2" /> Two
        </>
      ),
    },
    {
      ...
      label: (
        <>
          <FaStar className="inline-block mr-2" /> Three
        </>
      ),
    },
  ];
  ...
  return (
    <>
      ...
      <div className="flex flex-col -mt-35 h-[63px] items-center ">
        ...
        <h2 className="text-[#000000]    text-2xl  font-bold font-sans">
          Drop Us a Line
        </h2>
        <p className="text-[#000000]  mt-4  ml-8 text-[15px] w-225  font-sans">
      ...
      <div className="flex flex-row mt-30  w-full h-full  ">
        {/* Background Image */}
        <img src={contus} alt="Background" className="  w-300 h-120  " />
        {/* contact us form*/}
          ...
          <div className="flex   mt-25 flex-col ml-25">
            <div className="flex   w-[350px] h-[200px]  bg-white">
              <div className=" flex  space-x-3">
                <div>
                  {" "}
                  <MapPin className="text-4xl text-black    border-1 w-[25px] h-[25px] border-[#EE2478] rounded-full" />
                </div>

                <div className="flex   flex-col">
                  <p className="font-bold text-[15px] left-20 -mt-1">
                    Tajmeel Spot Location
                  </p>
                  <p className="text-[#545454]  font-sans    text-[15px]">
                    combined with a handful of model to
                  </p>
                  <p className="text-[#545454]  font-sans  text-[15px]">
                    {" "}
                    generate Lorem Ipsum which looks ener
                  </p>
                  <p className="text-[#545454]  font-sans    text-[15px]">
                    ated Lorem Ipsum is.
                  </p>
