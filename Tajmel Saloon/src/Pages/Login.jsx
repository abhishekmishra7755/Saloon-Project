            ...
            <div className='flex  mt-35    flex-col'>
                ...
                <div className='w-150 h-30  flex shadow-md  hover:bg-red-500 rounded-lg border border-[#000000]    mt-6 '>
                    <div className='flex ml-5  flex-col'>
                        <p className=' w-100  text-[25px] font-sans  font-bold size-[22px] mt-5 h-3'>Tajmeel For Customer</p>
                        <span className='size-[18px] mt-5   font-sans  ml-1 text-[20px] w-[400px]'>Book Saloon & Spa Near You</span>
                    </div>
                    <button 
                ...
                <div className=' mt-5  w-150 h-30 flex shadow-md rounded-lg  hover:bg-red-500 border border-[#000000] '>
                    <div className='flex flex-col ml-5'>
                        <p className=' w-100   font-bold  font-sans   text-[25px] size-[30px] mt-5 h-3'>Tajmeel For Professional</p>
                        <span className='size-[18px] mt-5  font-sans  ml-1 text-[20px] w-[400px]'>Manage and grow your Business</span>
                    </div>
                    <button
                ...
                <div className='flex w-[20px]  space-x-3 h-[20px]'>
                  <div className='text-[#000000]   hover:text-rose-600 space-x-2'><MessageCircleMore size={24} /></div> 
             <p className='text-[#000000] font-sans  hover:text-rose-600 text-[16px]'>English</p>
             </div>
              <div className='flex w-[20px]  space-x-3 h-[20px]'>
             
              <div className='text-[#000000]  hover:text-rose-600 '><Headphones size={24} /></div>
         <p className=' text-xl text-[#000000]  hover:text-rose-600 font-sans text-[16px]'>Support</p>
        </div>
        </div>
