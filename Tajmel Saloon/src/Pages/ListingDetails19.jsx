...
import { HeartIcon, Phone,Bookmark, Star, Zap, Share2,MapPin, Twitter, Linkedin, Facebook, Instagram, Youtube,Globe ,Mail, ThumbsUp, Clock } from 'lucide-react';
...
const reviews = [
  {
    ...
    review: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. ' +
...
const ListingDetails19 = () => {
  ...
  const openLink = (url) => {
    ...
    return (
        ...
        <div className='flex'>
        <img src={ld18} alt='haircut'  className='mt-3  h-[600px]  w-[640px]'/>
 ...
 '>
        ...
        <div className=" w-[489px] h-[500px] ml-12 mt-3 flex flex-col  bg-[#FBFAFA] border border-[#D4D4D4]
                           font-[sans-serif]">
         <div className='flex  space-x-60 mt-8 font-[sans-serif] '>
            <h1 className="text-[18px]   ml-8 space-y-80 font-bold text-[#000000]">Booking</h1>
             <p className="text-[15px] font-bold  mt-2 text-[#000000]">$149 Per Person</p>
       </div>
  <div className=" space-y-2">
    ...
    <select
      className=" p-3 w-[435px] h-[50px]   text-[#787878]  mt-4  ml-7  bg-[#FFFFFF] focus:outline-none focus:ring-2 focus:ring-[#ED2D77]"
    >
    ...
    <select
      ...
      className="w-[435px] h-[50px]  mt-4 p-3  text-[#787878] ml-7 bg-[#FFFFFF] focus:outline-none focus:ring-2 focus:ring-[#ED2D77]"
    >
    ...
    <select
      className="  w-[435px] h-[50px]  mt-4 p-3   text-[#787878] bg-[#FFFFFF]  ml-7 focus:outline-none focus:ring-2 focus:ring-[#ED2D77]"
    > 
      <option>Guest</option>
    ...
    <button
      className="w-[435px] h-[50px] ml-7 bg-[#EE2478] text-white py-3 font-bold hover:bg-pink-600"
    >
      Request Booking
    </button>

    <button
      className="w-[435px] h-[50px]  ml-7  bg-[#E7E7E7] flex items-center justify-center border  text-[#000000] py-3 font-bold hover:bg-pink-50"
    >
          ...
          className="w-[130px]  h-[100px]" />
           ...
           <div className='flex mt-3'>
            ...
            <div className='flex flex-col bg-[#FBFAFA]  w-[660px] h-[350px] shadow-[#0000000D]'> 
              <p className='font-bold text-[#000000]   ml-5 text-[20px]  mt-10 w-[200px] h-[20px]  font-[Brandon]'>Ladies Leg Waxing</p>
             ...
             <span className='w-[5px] h-[5px] text-[ #000000]'> <CiLocationOn /></span>
             <p className='font-sans  text-[16px]  -mt-1 text-[ #000000]'>Ut wisi enim ad minim veniam, quis</p>
              </div>
              <div className='flex w-[150px] mt-3 ml-5 gap-5  h-[20px]'>
                <span className='w-[12px] h-[12px] text-[ #000000]'> < FiPhoneCall/></span>
                 <span className='font-sans  text-[15px] -mt-1  text-[ #000000]'>1800 (123) 4567</span>
              </div>
      ...
      <div className="flex space-x-1 p-2   rounded-lg">
        {[...Array(4)].map((_, i) => (
          <div key={i} className=" p-2 rounded-md  text-[#F6BD00] w-[8px] h-[8px]">
    ...
    {/*   bookmark and  Reviews */}
        ...
        Open Now
          ...
          {/* desc and updown   form   listing dtails page */}
            ...
            <div className="flex flex-col   w-[489px] h-[450px]  bg-[#FBFAFA]  -mt-20   ml-7  border border-[#D4D4D4]  gap-4">
              <p className='font-blod  ml-8 mt-4 font-[Brandon]  text-[#000000]  text-[18px]'>Contact Info</p>
      ...
      />
        ...
        <span className="text-[15px] text-[#050505]  font-semibold">Kethy Brown</span>
        ...
        <Twitter className="text-white bg-[#C0C0C0] p-2 rounded-full" size={30} />
        <Linkedin className="text-white bg-[#C0C0C0]  p-2 rounded-full" size={30} />
        <Facebook className="text-white bg-[#C0C0C0]  p-2 rounded-full" size={30} />
        <Instagram className="text-white bg-[#C0C0C0]  p-2 rounded-full" size={30} />
        <Youtube className="text-white bg-[#C0C0C0]  p-2 rounded-full" size={30} />
      </div>
      ...
      <div className='flex w-[150px]  gap-5  ml-7 h-[20px]'>
         <span className='w-[15px] h-[15px] text-[#959595]'> <FiPhoneCall /></span>
         <span className='font-sans  text-[15px] -mt-1  text-[ #000000]'>1800 (123) 4567</span>
       </div>

        <hr className="w-full border-t border-[#D4D4D4] opacity-50" />
        <div className='flex w-[150px]  gap-8  ml-7 h-[20px]'>
         <span className='w-[3px] h-[13px] text-[#959595]'> <Globe  /></span>
         <span className='font-sans  text-[15px] -mt-1  text-[ #000000]'>www.tajmeel.com</span>
       </div>
       <hr className="w-full border-t border-[#D4D4D4] opacity-50" />
       <div className='flex w-[150px]  gap-5  ml-7 h-[20px]'>
         <span className='w-[15px] h-[15px] text-[#959595]'> <Mail /></span>
         <span className='font-sans  text-[15px] -mt-1  text-[ #000000]'>Info@tajmeel.com</span>
       </div>
    </div>             
    </div>
    </div>
      ...
      <div className='flex mt-3'>
        <div  className='flex flex-col'>
          <p className='font-bold'>Listing Description</p>
            <div  className='w-160 text-[#000000] mt-2  font-sans  text-[14px]'>
              ...
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis
               pulvinar. Donec a consectetur nulla. Nulla posuere sapien vitae lectus suscipit, et pulvinar nisi tincidunt.
               Aliquam erat volutpat. Curabitur convallis fringilla diam sed aliquam..
              </p>
            </div>
            <div  className='w-160 text-[#000000] mt-4 font-sans text-[14px]'>
              <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis
               pulvinar. Donec a consectetur nulla. Nulla posuere sapien vitae lectus suscipit, et pulvinar nisi tincidunt. Aliqua
         ...
         <span className='w-[15px]   ml-7  h-[15px] text-[#959595]'> <FiPhoneCall /></span>
         <span className='font-sans  text-[14px] -mt-1  text-[ #000000]'>1800 (123) 4567</span>
       
       </div>
       <div className='flex w-[200px] h-[30px]   items-center  border border-[#D0D0D0]  ml-7 gap-2 '>
         <span className='   text-[#959595] ml-5  '> <Mail  className='w-[15px] h-[15px]'/></span>
         <span className='font-sans  text-[14px] -mt-1  text-[ #000000]'>Info@tajmeel.com</span>
       </div>
       <div className='flex w-[200px] h-[30px] p-1  ml-10 border border-[#D0D0D0]  gap-2 '>
         <span className=' ml-5 text-[#959595] '> < Globe   className='w-[15px] h-[15px]' /></span>
         <span className='font-sans  text-[14px] -mt-1  text-[ #000000]'>www.tajmeel.com</span>
       </div>
          </div>
        ...
        <button onClick={() => openLink("https://www.facebook.com")} className="flex items-center gap-2 bg-[#38529A] text-[#FFFFFF] px-4 py-2 ">
          <Facebook size={20} /> Facebook
        </button>
        <button onClick={() => openLink("https://www.twitter.com")} className="flex items-center gap-2 bg-[#1C9CEA] text-[#FFFFFF] px-4 py-2 ">
          <Twitter size={20} /> Twitter
        </button>
        <button onClick={() => openLink("https://www.instagram.com")} className="flex items-center gap-2 bg-[#E1306C] text-[#FFFFFF] px-4 py-2 ">
          <Instagram size={20} /> Instagram
        </button>
        <button onClick={() => openLink("https://www.linkedin.com")} className="flex items-center gap-2 bg-[#2877B5] text-[#FFFFFF] px-4 py-2 ">
          <Linkedin size={20} /> Linkedin
        </button>
        <button  onClick={() => openLink("https://www.youtube.com")} className="flex items-center gap-2 bg-[#F00125] text-[#FFFFFF] px-4 py-2 ">
          <Youtube size={20} /> Youtube
            ...
            <div className="flex flex-col   w-[489px] h-[450px]  bg-[#FBFAFA]  -mt-20   ml-7  border border-[#D4D4D4]  gap-4">
              <p className='font-blod  ml-5 mt-4 font-[Brandon]  text-[#000000]  text-[18px]'>Business Hours</p>
         <hr className="w-full border-t border-[#D4D4D4] opacity-50" />
      ...
      <hr className="w-full border-t border-[#D4D4D4] opacity-50" />
       <div className="flex items-center  space-x-73 ml-5 gap-2">
        ...
        <span>9.30 AM - 9.00</span>
         ...
         <span className='   ml-7  h-[15px] text-[#000000]'> <AiFillTag /></span>
         <span className='font-sans  text-[12px] -mt-1  text-[#000000]'>Hair Saloon</span>
       
       </div>
       <div className='flex w-[150px] h-[30px]  p-1 items-center  border border-[#D0D0D0]  ml-7 gap-2 '>
         <span className='   text-[#000000] ml-5  '> <AiFillTag className='w-[15px] h-[15px]'/></span>
         <span className='font-sans  text-[12px] -mt-1  text-[#000000]'>Dental</span>
       </div>
       <div className='flex w-[150px] h-[30px] p-1  ml-10 border border-[#D0D0D0]  gap-2 '>
         <span className=' ml-5 text-[#000000] '> < AiFillTag className='w-[15px] h-[15px]' /></span>
         <span className='font-sans  text-[12px] -mt-1  text-[#000000]'>Diversity of Clinic</span>
       </div>
          </div>
          </div>
          ...
          <div className='flex bg-[#F3F3F3] w-[680px] mt-8 h-[120px] border border-[#CBCBCB]'>
            <div className='flex flex-col mt-4 ml-5'> 
              ...
              <span className='text-[#000000] text-[15px]'>From Iraqi Dinar 70</span>
          ...
          <div className='flex w-[680px] mt-8 h-[120px] border border-[#CBCBCB]'>
            <div className='flex flex-col mt-4 ml-5'> 
              ...
              <span className='text-[#292929] text-[15px]' >30 Mins - 1 hr</span>
              <div className='flex'>
              <span className='text-[#000000] text-[15px]'>From Iraqi Dinar 120</span>
      ...
      <div className=" relative w-[410px] h-[240px] ml-10    -mt-6  max-w-md">
        <h1 className=" text-[18px] font-bold mt-7 ml-8  w-[340px] h-[30px] ">Book Now & Get 50% Discount</h1>
        <button className='text-[#FFFFFF] font-sans bg-[#EE2478] mt-4 w-[200px] h-[35px] text-[15px]' >
        Date of Expire    05/02/2025
             </button>
       <p className='text-[13px] text-[#FFFFFF] font-sans mt-2  ml-20 w-[250px] h-[50px]'>How to use? Just show us this coupan
       on a screen</p>
     
        <div className=" flex  mt-3 items-center with-[100px] h-[45px] gap-4 bg-[#00000066] bg-blur-[1px] ">
             <span className='text-[14px] text-[#FFFFFF]  ml-25  font-sans'> Coupan Code</span> 
           <span className=" text-[#8A8A8A]  font-sans  items-center w-[100px] h-[30px] text-[14px] bg-[#FFFFFF]  blur-[px] border  border-[#EE2478]">DL 75T 12</span>
        </div>
      </div>
    </div>
          </div>
       ...
       <div className='flex flex-col mt-5  '>
        <p className='text-[#000000] font-[Brandon]  font-bold text-[18px]'>Reviews (08) </p>
      ...
      />
        ...
        <p className='w-[420px] text-[12px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque.
           pulvinar. Donec a consectetur nulla. Nulla posuere sapien vitae lectus suscipit, et pulvi
                 Aliquam erat volutpat. Curabitur convallis fringilla diam sed aliquam. </p>
          </div>
          </div>
      ...
      <div className="w-full     max-w-2xl space-y-6">
        {reviews.map(({ id, name,date, image, review }) => (
          <div key={id} className="bg-white p-6 rounded-xl shadow-lg    flex gap-4 items-center">
            <img
              src={image}
              alt={name}
            ...
            <div>
              ...
              <h2 className="text-[14px] ml-1 font-semibold   text-[#000000]">{name}</h2>
              <div className="flex items-center text-gray-500 text-sm mt-1">
                <Clock size={14} className="mr-1" /> {date}
              </div>
              <p className="text-[14px]  w-[400px] text-[#000000]  mt-2">{review}</p>
              <button
                className={`mt-2 text-sm flex items-center w-[120px] h-[35px]  border border-[#D9D9D9] gap-1 hover:underline ${likedReviews[id] ? 'text-red-500' : 'text-[#5E5E5E]'}`}
                onClick={() => toggleLike(id)}
              > 
              <p className="ml-1">Helpful Review</p>
                <ThumbsUp size={16} fill={likedReviews[id] ? "red" : "none"} stroke="currentColor" /> 
              </button>
            </div>
          </div>
        ))}
     ...
     <p className='font-bold font-[Brandon] text-center text-[25px] text-[#000000]'>Similar Listing</p>
...
export default ListingDetails19;
