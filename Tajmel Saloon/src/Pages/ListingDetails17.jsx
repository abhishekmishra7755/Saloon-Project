...
const ListingDetails17 = () => {
  ...
  const openLink = (url) => {
    ...
    return (
        ...
        <div className='flex'>
        <img src={ld16} alt='haircut'  className='mt-3  h-[600px]  w-[640px]'/>
          ...
          className="w-[130px]  h-[100px]" />
           ...
           <div className='flex mt-3'>
            ...
            <div className='flex flex-col bg-[#FBFAFA]  w-[660px] h-[350px] shadow-[#0000000D]'> 
              <p className='font-bold text-[#000000]   ml-5 text-[20px]  mt-10 w-[200px] h-[20px]  font-[Brandon]'>Iraq Waxing</p>
...
export default ListingDetails17;
