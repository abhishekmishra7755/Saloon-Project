  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        ...
        <h1 className=" -ml-55 text-[30px] font-[crimson]  text-[sans]  font-bold mt-8">
          Tajmeel for Customers
        </h1>
        <p className=" text-[#000000] text-[20px]  font-sans -ml-8 p-3 mb-2">
        ...
        >
          ...
          <div className="mt-7">
            <button
              type="submit"
              className="w-full bg-black rounded  h-[55px] hover:bg-[#EE2478]   text-[20px]   cursor-pointer rounded-b-lg text-[#FFFFFF] py-2 transition"
            >
              Continue
            </button>
            ...
            <button
              type="submit"
              className="w-full bg-black mt-5 rounded  h-[55px] hover:bg-[#EE2478]  cursor-pointer rounded-b-lg text-[#FFFFFF] py-2 transition"
            >
              <a
        ...
        <p className=" -mt-40   text-[20px] flex-col text-[#000000]">
          ...
          <a
            href="/professional"
            className="text-[#EE2478] flex ml-30  hover:text-black   hover:underline"
          >
