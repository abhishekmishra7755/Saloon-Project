...
const AboutUs = () => {
  ...
  const sections = [
    {
      icon: (
        <img src={vission} sizes="" alt="icon" className="text-[#FFFFFF]" />
      ),
      title: "Our Mission",
      description:
        "Combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem desc.",
    },
    {
      icon: (
        <img src={vission} sizes={40} alt="icon" className="text-[#FFFFFF]" />
      ),
      title: "Our Vision",
      description:
        "Combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem desc.",
    ...
    <div className="w-full h-full ">
      <div className=" overflow-x-hidden w-full   h-screen">
        ...
        <div className="flex mt-50 items-center">
          <div className="relative  ml-100 h-28 w-1"></div>
          <div className="flex flex-col">
            <div className="relative ml-150">
              {" "}
            ...
            <div className="relative  flex-col  w-[540px] ml-75">
              ...
              <br />
              <span className="text-[15px]  ml-15 font-sans text-[#FFFFFF]">
      ...
      <div className="flex  bg-[#EE247833] justify-between    items-center  w-[1450px] -ml-22  h-[153px] -mt-53">
        <div className="flex flex-col ml-20">
          <p className="font-bold  font-sans  text-[20px] text-[#000000]">
            Trusted by over
          </p>
        ...
        <div className="flex  -ml-30 flex-col">
          <p className="font-bold  font-sans  text-[30px] text-[#000000]">
            {Math.floor(count / 49000)} Lakh +
          </p>
          <span className=" font-sans  -ml-5 text-[14px]  text-[#000000]">
            Appointments Booked
          </span>
        </div>
        ...
        <div className="flex flex-col mr-30">
          ...
          <span className=" font-sans  text-[14px]  -ml-15   text-[#000000]">
            States with Tajmeel spot Available
          </span>
        </div>
      </div>
      ...
      <div className="flex">
        <div className="flex mt-60 flex-col">
          <h2 className="text-[#000000]  font-bold font-sans text-[25px]">
            Who Is Tajmeelspot
          </h2>
          <p className="text-[#000000]  w-150 mt-2 font-sans text-[15px]">
            ...
            necessary, making this the first true generator the Internet. It
            uses a dictionary of over 200 Latin words,
          </p>
          <p className="text-[#000000]    w-150 mt-5 font-sans text-[15px]">
      ...
      <div>
        <div className="flex flex-col md:flex-row justify-around    w-380   -ml-35 mt-15 items-center p-8 bg-[#000000B2]">
          {sections.map((section, Values) => (
            <div
              key={Values}
              className="flex flex-col items-center text-center p-4 m-4  rounded-2xl shadow-lg w-80"
            >
              {section.icon}
              <h3 className="text-xl text-[#FFFFFF]  font-bold mt-4">
                {section.title}
              </h3>
      ...
      <div className="flex ">
        ...
        <div className="flex mt-50 flex-col">
          <h2 className="text-[#000000]  font-bold font-sans text-[20px]">
            Our Favorite Salon at Your Fingertips
          </h2>
          <p className="text-[#000000]  w-160 mt-2 font-sans text-[15px]">
            There are many variations of passages of Lorem Ipsum available, but
