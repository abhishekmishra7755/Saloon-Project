...
import hr1 from '../assets/img/hr1.png'
import hr2 from '../assets/img/hr2.png'
import hr3 from '../assets/img/hr3.png'
import hr4 from '../assets/img/hr4.png'
import hr5 from '../assets/img/hr5.png'
import hr6 from '../assets/img/hr6.png'
     ...
     <div className="flex flex-col w-100    focus:outline-none items-start space-y-2 mt-4">
          ...
          <div className="flex flex-col     w-100 focus:outline-none items-start space-y-2 mt-4">
            ...
            className=" underline ml-3 font-bold  hover:text-[#EE2478] cursor-pointer  text-black">Read More</button>
               ...
               {/*  treatments hair removal description 1*/}
        ...
        <p className=" mt-3 ml-15 font-normal font-sans text-[#000000]">Liverpool </p>
        <p className=" mt-3 ml-15 font-normal font-sans text-[#000000]">Manchester</p>
        ...
        <p className=" mt-3  font-normal font-sans text-[#000000]">Edinburgh</p>
        ...
        <p className=" mt-3 font-normal font-sans text-[#000000]">Glasgow</p>
                ...
                {/*  treatments hair removal description  2*/}
        ...
        <p className=" mt-3 ml-12 font-normal  text-[15px] font-sans text-[#000000]">Afro Hairdressing </p>
        <p className=" mt-3 ml-25 font-normal  w-[180px]  text-[15px] font-sans text-[#000000]">Beard Trimming & Shaving</p>
        <p className=" mt-3 ml-1 font-normal  text-[15px] font-sans text-[#000000]">Braids</p>
      
          </div>
          
          <div> 
        
        <p className=" mt-3  font-normal  text-[15px] font-sans text-[#000000]">Children's Haircuts </p>
        <p className=" mt-3  font-normal text-[15px] font-sans text-[#000000]">Hair Loss Treatments</p>
        <p className=" mt-3  font-normal  text-[15px] font-sans text-[#000000]">Hair Styling and Updos</p>
        ...
        <p className=" mt-3 font-normal font-sans   text-[15px] text-[#000000]">Japanese Straightening</p>
        <p className=" mt-3 font-normal font-sans  w-[200px] text-[15px] text-[#000000]">Ladies' Hair Conditioning and ScalpTreatments</p>
        <p className=" mt-3  font-normal font-sans  text-[15px] text-[#000000]">Men's Hair Colouring</p>
      ...
      <p className=" mt-3 font-normal font-sans text-[15px] text-[#000000]">Men's Haircut</p>
      <p className=" mt-3 font-normal font-sans  text-[15px] text-[#000000]">Permanent Waves</p>
      <p className=" mt-3  font-normal  text-[15px]  font-sans text-[#000000]">Wedding Hair</p>
            ...
            <div className='  mt-5'>
              ...
              <div  className='w-265 text-[#000000]  font-sans  mt-4 text-[15px]'>
               ...
               Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum 
                ...
                of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics,
                </p>
              </div>
