  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="h-full w-full">
        ...
        <p className="text-[#010101] font-sans  ml-64 w-[690px] text-[15px]">
          quis nostrud exerci tation ullamcorper suscipit lobor nisl ut aliquip
          ex ea commodo consequat. Duis aute
        </p>
        <p className="text-[#010101] font-sans  ml-125 w-[690px] text-[15px]">
        ...
        <div className="flex flex-wrap justify-center gap-30 p-6">
          {features.map((feature, index, desc) => (
            ...
            >
              <div className="text-[#F48CA4]   rounded-4xl border border-[#F48CA4]">
                {feature.icon}
              </div>
              <p className="mt-2 text-center text-[15px] font-[Brandon]  font-bold">
                {feature.text}
              </p>
              <p className="mt-2 text-center text-[#010101] text-[13px]">
                {feature.desc}
              </p>
            </div>
          ))}
        ...
        <div className=" space-x-20  ml-12 mt-10 ">
          <p className=" mt-4  font-[Brandon] font-bold text-[30px] text-[#000000]">
            Popular Treatement
          </p>
        </div>
        ...
        <div className="relative mt-3 ml-12 border-radius w-full max-w-lg mx-auto group">
          <div className="flex space-x-4">
            <img src={ldg} alt="img1" className="w-70 " />
            <img src={ld10} alt="img2" className="w-70" />
            <img src={ld11} alt="img3" className="w-70 " />
            <img src={ld12} alt="img4" className="w-70" />
          </div>
        </div>
        {/* description */}
        <div className="relative  flex  h-105 w-70 -mt-4 ml-12 max-w-lg max-auto group">
          <div className="flex flex-row  space-x-4">
            <div className="flex flex-col  border border-[#D9D9D9]  w-70 focus:outline-none items-start space-y-2 mt-4">
              <p className="  ml-4 mt-3  hover:text-[#ED2D77] cursor-pointer font-[Brandon]  text-[20px] font-bold">
                Deep Tissue Massage
              </p>
              <div className="flex mt-3 ml-1 items-center">
                <span className=" -mt-3 ml-3 text-[17px] text-[#868686]">
                  4.9
                </span>
                <FaStar className="text-black -mt-3  ml-1" />
              </div>
              <p className="text-[#868686] mt-1  font-sans text-[20px]  w-[245px] ml-4">
              ...
              <button
                onClick={handleClick}
                className=" text-black ml-3 w-30 h-8  hover:bg-[#ED2D77] active:bg-[#ED2D77]     cursor-pointer     hover:text-white  mt-2 border border-[#ED2D77]"
              >
                View Details
              </button>
            </div>
            {/* description 2*/}
            <div className="flex flex-col  border border-[#D9D9D9]   w-70 focus:outline-none items-start space-y-2 mt-4">
              <p className="  ml-4 mt-3   text-[20px]  cursor-pointer  hover:text-[#ED2D77]  font-[Brandon]   font-bold">
                Swedish Massage
              </p>
              <div className="flex mt-3 ml-1 items-center">
                <span className=" -mt-3 ml-3 text-[17px] text-[#868686]">
              ...
              <button
                ...
                className=" text-black ml-3 w-30 h-8 mt-2 hover:bg-[#ED2D77] active:bg-[#ED2D77]   cursor-pointer   hover:text-white    mb-1 border border-[#ED2D77]"
              >
                View Details
              </button>
            </div>
            <div className="flex flex-col   border border-[#D9D9D9]  w-70 focus:outline-none items-start space-y-2 mt-4">
              <p className="  ml-4 mt-3  hover:text-[#ED2D77]  cursor-pointer   text-[20px]   font-[Brandon]   font-bold">
                Therapeutic Massage
              </p>
              ...
              <button
                ...
                className=" text-black ml-3 w-30 h-8  hover:bg-[#ED2D77] active:bg-[#ED2D77]   cursor-pointer   mt-2  mb-1 border    hover:text-white  border-[#ED2D77]"
              >
                View Details
              </button>
            </div>
            <div className="flex flex-col   border border-[#D9D9D9]  w-70 focus:outline-none items-start space-y-2 mt-4">
              ...
              <button
                ...
                className=" text-black ml-3 w-30 h-8  hover:text-white   cursor-pointer   mt-2 hover:bg-[#ED2D77] active:bg-[#ED2D77]  mb-1 border border-[#ED2D77]"
              >
                View Details
              </button>
            </div>
        ...
        <div className="relative mt-10 ml-12 border-radius w-full max-w-lg mx-auto group">
          <div className="flex space-x-4">
            <img src={ld13} alt="img1" className="w-70 " />
            <img src={ld14} alt="img2" className="w-70" />
            <img src={ld15} alt="img3" className="w-70 " />
            <img src={ld16} alt="img4" className="w-70" />
          </div>
        </div>
        {/* description */}
        <div className="relative  flex  h-105 w-70 -mt-4 ml-12 max-w-lg max-auto group">
          <div className="flex flex-row  space-x-4">
            <div className="flex flex-col  border border-[#D9D9D9]  w-70 focus:outline-none items-start space-y-2 mt-4">
              ...
              <button
                ...
                className=" text-black ml-3 w-30 h-8  hover:bg-[#ED2D77] active:bg-[#ED2D77]    cursor-pointer  mt-2 border   hover:text-white    border-[#ED2D77]"
              >
                View Details
              </button>
            </div>
            {/* description 2*/}
            <div className="flex flex-col  border border-[#D9D9D9]   w-70 focus:outline-none items-start space-y-2 mt-4">
              <p className="  ml-4 mt-3 cursor-pointer  text-[20px]  hover:text-[#ED2D77]  font-[Brandon]   font-bold">
                Ladies Waxing
              </p>
              <div className="flex mt-3 ml-1 items-center">
                <span className=" -mt-3 ml-3 text-[17px] text-[#868686]">
              ...
              <button
                ...
                className=" text-black ml-3 w-30 h-8     hover:text-white mt-2 hover:bg-[#ED2D77] active:bg-[#ED2D77]    cursor-pointer  mb-1 border border-[#ED2D77]"
              >
                View Details
              </button>
            </div>
            <div className="flex flex-col   border border-[#D9D9D9]  w-70 focus:outline-none items-start space-y-2 mt-4">
              <p className="  ml-4 mt-3 cursor-pointer  hover:text-[#ED2D77]   text-[20px]   font-[Brandon]   font-bold">
                Chest Waxing
              </p>
              <div className="flex mt-3 items-center">
                <span className=" -mt-3 ml-3 text-[17px] text-[#868686]">
              ...
              <button
                ...
                className=" text-black ml-3 w-30 h-8  hover:bg-[#ED2D77] active:bg-[#ED2D77]  cursor-pointer mt-2  mb-1    hover:text-white border border-[#ED2D77]"
              >
                View Details
              </button>
            </div>
        ...
        <div className="relative mt-3 ml-12">
          <div className="flex space-x-4">
            <img src={ld17} alt="img1" className=" w-70  h-70" />
            <img src={ld18} alt="img2" className="w-70 h-70" />
          </div>
        </div>
        {/* description1 */}
        <div className="relative  flex  h-105 w-70 -mt-4 ml-12 max-w-lg max-auto group">
          <div className="flex flex-row  space-x-4">
            <div className="flex flex-col  border border-[#D9D9D9]  w-70 focus:outline-none items-start space-y-2 mt-4">
              ...
              <button
                ...
                className=" text-black ml-3 w-30 h-8    hover:text-white hover:bg-[#ED2D77] active:bg-[#ED2D77]  cursor-pointer mt-2 border border-[#ED2D77]"
              >
                View Details
              </button>
            </div>
          ...
          <div>
            <div className="flex flex-row  space-x-4">
              <div className="flex flex-col     w-100  focus:outline-none items-start space-y-2 mt-4">
                <p className=" ml-3   cursor-pointer  hover:text-[#ED2D77] mt-3 font-bold">
                  diversity of clinic{" "}
                </p>
                <button className=" text-[#010101] cursor-pointer hover:bg-[#ED2D77]     hover:text-white  ml-3 w-25 h-8  mb-1 border border-[#EE2478]">
                  Get the App
                </button>
              </div>
            </div>
          ...
          <div>
            <div className="flex flex-row  space-x-4">
              <div className="flex flex-col  ml-5    w-100  focus:outline-none items-start space-y-2 mt-4">
                ...
                <button className=" text-[#010101] ml-3 w-25 h-8  mb-1 border border-[#EE2478]   hover:text-white  cursor-pointer hover:bg-[#ED2D77] ">
                  Get the App
                </button>
              </div>
            </div>
          ...
          <div>
            <div className="flex flex-row  space-x-4">
              <div className="flex flex-col  ml-10  w-100  focus:outline-none items-start space-y-2 mt-4">
                <p className="ml-3  cursor-pointer  hover:text-[#EE2478]  mt-3 font-bold">
                  diversity of clinic{" "}
                </p>
                <button className=" text-[#010101]  cursor-pointer hover:bg-[#ED2D77]  ml-3 w-25 h-8  mb-1 border   hover:text-white   border-[#EE2478]">
                  Get the App
                </button>
              </div>
            </div>
      ...
      <div className="flex bg-[#F8F8FA]  py-0 px-0 w-[1500px] h-[500px]">
        ...
        <div className="flex bg-[#F8F8FA]  py-0 px-0 w-[1500px] h-[500px]">
          ...
          <div className="flex -ml-150 flex-col">
            <p className="font-bold text-[28px] mt-50 w-[400px] text-[#000000]  font-[Brandon]">
              Own a Hair & Beauty Business?Bring it online.
            </p>

            <p className="text-[15px] mr-90 mt-2 font-sans w-[460px] text-[#000000] ">
      ...
      <div className="w-full h-full flex">
        <div className="flex flex-col ml-13 mt-25">
          <p className="text-[#000000]   font-bold  text-[35px]">
            {" "}
            <span className="text-[#EE2478] font-bold text-[35px]">
              Download
            </span>{" "}
            our APP
          </p>
          <p className="text-[13px]  text-[#010101] w-[400px]">
            quis nostrud exerci tation ullamcorper suscipit lobor nisl ut
            aliquip ex consequat. Duis aute vel eum iriure dolor in hendrerit
            in.
          </p>
          <button className=" text-[#010101] w-25 h-8  mt-3   hover:text-white  cursor-pointer hover:bg-[#ED2D77] text-[13px]    border border-[#EE2478]">
            Get the App
          </button>
        ...
        <div>
          <img
            src={dl}
            alt="phoneImg"
            className="mt-15 w-[630px]  ml-40 h-[330px]"
          />
          <p className="text-[#000000] ml-149 font-bold  w-[120px] -mt-54 text-[20px]">
            {" "}
            <span className="text-[#EE2478]   font-bold w-[150px] text-[20px]">
              Download
            </span>{" "}
            our app
          </p>
          <IoCloudUploadOutline
            size={40}
            className="ml-150 mt-3  text-[#EE2D77] "
          />
        </div>
      </div>
      ...
      <div className="mt-40  py-0 px-0 -ml-30   bg-[#F8F8FA] w-[1600px] h-[700px] ">
        <div className="flex  ml-30">
          ...
          <div className="flex flex-col mt-60  -ml-65">
            <p className="font-bold text-[30px] font-[Brandon]   text-[#000000] ">
              Quick & Easy
            </p>
            <p className="font-sans text-[15px] text-[#010101]">
              1000s of Salons Coming Onboard
            </p>
            <p className="font-sans text-[13px]  w-[490px] text-[#000000]">
              simply dummy text of the printing and typesetting industry. Lorem
              Ipsum has been the industry's standard dummy text ever since the
              1500s, when an unknown printer took a galley of type and scrambled
              it to make a type specimen book.{" "}
            </p>
            <button className=" text-[#010101]  cursor-pointer hover:bg-[#ED2D77]   w-25 h-8 mt-4 mb-1    hover:text-white border  hover:shadow-[#ED2D77] border-[#EE2478]">
              Get the App
            </button>
            <div className="w-[500px] h-[39px] flex mt-5 space-x-20">
              <div className="flex space-x-1 ">
                ...
                <p className="text-[#0C0C0C] font-bold  cursor-pointer hover:text-[#ED2D77]  font-[Brandon] text-[18px]">
                  Customer Help Centre
                </p>
              </div>
              <div className="flex space-x-1 ">
                <div className="text-[#000000] hover:text-[#ED2D77] ">
        ...
        <div className="flex flex-col w-[120px]  shadow-md items-center h-[120px] ml-50 mt-65  bg-[#FFFFFF] border border-[#ED2D77] rounded-full">
          ...
          <p className=" text-[12px] font-[Montserrat] text-[#000000]">
            Partner Onboard
          </p>
        </div>
      </div>
