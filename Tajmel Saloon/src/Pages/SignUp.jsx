  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        ...
        <h1 className="text-[25px]   w-[400px]  font-sans  -ml-30 font-bold text-[#000000]   mt-5">
          Sign Up for Customer Services
        </h1>
        <p className=" text-[#000000]  text-[20px] font-sans -ml-33 p-3 mb-2">
